...
'''
@Todo Write a version that allow pass the type of electrolyte and return the corresponding converted value
Spefically, write a better understandable version of potential conversion.
'''
...
# %%
# LSV data pretreatment in multiple subfolders under a parent folder, convert it to RHE, plot together
...
def PlotLSV(Solvent: str, color_index, label: str, criteria_current=1):
    ...
    #    try:
    #        if Solvent == 'KOH':
    #            plt.savefig(os.path.join(os.getcwd(),'Plot/LSVvsRHE_KOH_3mA.png'), dpi = 600)
    #        elif Solvent == 'Phos':
    #            plt.savefig(os.path.join(os.getcwd(),'Plot/LSVvsRHE_Phosphate_3mA.png'), dpi = 600)
    #        elif Solvent == 'CoSex':
    #            plt.savefig(os.path.join(os.getcwd(),'Plot/LSVvsRHE_CoSex_3mA.png'), dpi = 600)
    #        else:
    #            plt.savefig(os.path.join(os.getcwd(),'Plot/LSVvsRHE_all_10mA.png'), dpi = 600)
    #    except FileNotFoundError:
    #        os.mkdir('Plot')
    #        plt.savefig(os.path.join(os.getcwd(),'Plot/LSVvsRHE_final_10rep.png'), dpi = 600)
    else:
        print("continue")
